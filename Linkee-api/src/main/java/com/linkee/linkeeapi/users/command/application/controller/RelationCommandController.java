...
import com.linkee.linkeeapi.users.command.application.dto.request.RelationCreateRequest;
import com.linkee.linkeeapi.users.command.application.service.RelationCommandService;
...
@RequestMapping("/api/v1/users/relation")
