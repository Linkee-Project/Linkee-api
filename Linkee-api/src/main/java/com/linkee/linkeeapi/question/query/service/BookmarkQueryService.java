...
import com.linkee.linkeeapi.question.query.mapper.BookmarkMapper;
...
public class BookmarkQueryService {
    ...
    // 전체 북마크 조회
    public PageResponse<BookmarkListResponseDto> selectAllBookmarks(BookmarkSearchRequest request) {
        ...
        List<BookmarkListResponseDto> results = bookmarkMapper.selectAllBookmarks(requestMapper);
    ...
    // 내 북마크 조회
    public PageResponse<BookmarkListResponseDto> selectBookmarksByUserId(BookmarkSearchRequest request) {
        int page = request.getPage() != null && request.getPage() > 0 ? request.getPage() : 0;
        int size = request.getSize() != null && request.getSize() > 0 ? request.getSize() : 10;
        int offset = page * size;
        ...
        List<BookmarkListResponseDto> results = bookmarkMapper.selectBookmarksByUserId(requestMapper);
