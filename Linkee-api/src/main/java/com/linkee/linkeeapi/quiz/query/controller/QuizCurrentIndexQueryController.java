...
import com.linkee.linkeeapi.quiz.query.dto.response.CurrentQuestionResponse;
import com.linkee.linkeeapi.quiz.query.dto.response.QuizReconnectStateResponse;
import com.linkee.linkeeapi.quiz.query.service.QuizCurrentIndexQueryService;
...
public class QuizCurrentIndexQueryController {
    ...
    /* 현재 문제 인덱스 조회 */
    @GetMapping("/{roomId}/current/index")
    ...
    /* 재접속 복원용 전체 상태 조회 */
    @GetMapping("/{roomId}/current/reconnect-state")
